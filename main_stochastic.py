...
for i in range(args.iter):
    ...
    for j in range(args.epoch_iter):
        ...
        overflow_cost, via_cost, wire_length_cost, max_overflow, hor_overflow, ver_overflow = model.objective_function(RoutingRegion, hor_path, ver_path, wire_length_count, via_info, p,args,iteration=j, hor_batch_size=hor_batch,ver_batch_size=ver_batch, hor_shuffled_indices=hor_shuffled_indices,ver_shuffled_indices=ver_shuffled_indices)
