...
sns.set()
# read step1.csv
df = pd.read_csv('./ray_results/ispd18_test8_metal5_scheduler.csv')
print(df)
...
# set title as "ispd18_test8_metal5"
fig.suptitle('ispd18_test8_metal5: scheduler vs. quality')
...
# plt.savefig('ispd18_test8_metal5_lr.png')

# # create four boxplots in a figure, x axis is `config/scheduler`, y axis is score, wirelength, via_count, first_overflow, respectively
...
plt.savefig('ispd18_test8_metal5_scheduler.png')
